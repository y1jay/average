	...
	const logIn = async (token, uid, type) => {
		...
		await axios
			.get(`${config.apiUrl}/user/member/userLogIn`, {
				params: { uid: uid, join_type: type, device_uuid: deviceUuid },
			})
			.then(async (res) => {
	...
	const Login = () => {
		return (
			<View style={commonStyles.body}>
				...
				<Text style={commonStyles.loginExplain}>
					SNS 계정으로 로그인
				</Text>
					...
					<View style={{ flexDirection: "row" }}>
						...
						>
							<ImageBackground
								...
								resizeMode="cover"
							></ImageBackground>
							<View style={styles.myInfoPencil}>
								<Image
						...
						>
							...
							<View style={{ flexDirection: "row" }}>
								<Text style={styles.myInfoCardCnt}>
									남은카드
									<Text style={{ fontWeight: "bold" }}>
										{isLogin && (change || !change)
											? userInfo.current.paid_count
											: "0"}
									</Text>
								</Text>
					...
					<View style={styles.myInfoCntArea}>
						<View style={styles.myInfoCntItem}>
							<View style={styles.myInfoCntItemTitleArea}>
								<Text style={styles.myInfoCntItemTitle}>
									좋아
								</Text>
								<Image
									source={require("../../Images/heart_white.png")}
								/>
							</View>
						...
						<View style={styles.myInfoCntItem}>
							<View style={styles.myInfoCntItemTitleArea}>
								...
								<Image
									source={require("../../Images/good_white.png")}
								/>
							</View>
							<Text style={styles.myInfoCntItemText}>00</Text>
						</View>
