		...
		<Swiper 
			...
			<View 
				...
				<ImageBackground 
					...
					<Pressable style={styles.contentsText}><Text>취향 검사 하러가기</Text></Pressable>
				</ImageBackground>
			</View>
			<View 
				style={styles.slideItem}>
				<ImageBackground 
					...
					<Pressable style={styles.contentsText}><Text>달달러버 OH_123456</Text></Pressable>
				</ImageBackground>
			</View>
      	</Swiper>
		<Pressable style={styles.cardCntArea}><Text>보유 횟수</Text></Pressable>
	</AnimatedBackgroundColorView>
	)
}
