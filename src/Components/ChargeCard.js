                    ...
                    <Pressable style={styles.modalArea}>
                        ...
                        <View style={styles.chargeCardBtnArea}>
                            <Pressable 
                                ...
                                <Image style={styles.chargeCardImg} source={require('../Images/chargeCard_pay.png')}/>
                                <Text style={[styles.chargeCardText, {color: '#F59300'}]}>₩1000</Text>
                            </Pressable>
                            <Pressable
                                onPress={() => {alert('광고!')}}
                                style={styles.chargeCardBtn}>
                                <Text style={styles.chargeCardCnt}>x 1</Text>
                                <Image style={styles.chargeCardImg} source={require('../Images/chargeCard_free.png')}/>
                                <Text style={[styles.chargeCardText, {color: '#007A31'}]}>무료</Text>
                            </Pressable>
                        </View>
                        <Pressable
                            onPress={() => {setModalVisible(false)}}
